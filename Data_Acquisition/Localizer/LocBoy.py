...
fig.legend((Fz, Cz, Pz, P4, P3, O1, O2), ('Fz', 'Cz', 'Pz', 'P4', 'P3', 'O1', 'O2'), 'center left')
# Trial Averages.
p3 = np.squeeze(p3)
p3 = p3[0:time_idx]
...
fig.legend((Fz, Cz, Pz, P4, P3, O1, O2), ('Fz', 'Cz', 'Pz', 'P4', 'P3', 'O1', 'O2'), 'center right')
# Trial Averages.
np3 = np.squeeze(np3)
np3 = np3[0:time_idx]
...
pb.sub_band_chunk_plot(eeg_sub, divs=5, pow_disp='REL', plotter=1)

# Useful Info
# print('AVG EEG SUB DIMS: ', eeg_sub_avg.shape)
# print('EEG SUB AVG VALS: ', eeg_sub_avg.shape, eeg_sub_avg[0:10])
# print('EEG SUB AVG POW VALS: ', values)
